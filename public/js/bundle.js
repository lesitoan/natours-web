  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === "data" ? 'http://localhost:8080/api/v1/users/update-me' : 'http://localhost:8080/api/v1/users/update-password';
          console.log(url);
          _context.next = 5;
          return (0, _axios.default)({
            method: "patch",
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var btnFormLogin = document.querySelector('.form--login');
var btnLogout = document.querySelector('.nav__el--logout');
var btnFormUserData = document.querySelector('.form-user-data');
var btnFormUserPassword = document.querySelector('.form-user-password');
if (btnFormLogin) {
  btnFormLogin.addEventListener('submit', function (e) {
    e.preventDefault();
...
;
if (btnFormUserData) {
  btnFormUserData.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (btnFormUserPassword) {
  btnFormUserPassword.addEventListener('submit', /*#__PURE__*/function () {
